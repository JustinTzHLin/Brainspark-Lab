...
const SignupConfirmAlert: React.FC<SignupConfirmAlertProps> = ({ SignupConfirmIsOpen, setSignupConfirmIsOpen, cancelSignupConfirmRef, email}) => {
  const dispatch = useAppDispatch();

  return (
    <DialogRoot motionPreset='scale' onOpenChange={e => setSignupConfirmIsOpen(e.open)} open={SignupConfirmIsOpen} placement='center' onExitComplete={() => dispatch(replaceAction('login'))}>
      <DialogBackdrop />
      <DialogContent>
        <DialogHeader>
